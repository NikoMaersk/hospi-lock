...
export default function Welcome() {
  ...
  return (
    <div className="flex gap-6 w-full mt-10 items-center lg:justify-center ">
      <div className="text-center leading-8 md:text-left w-1/3">
        <div className="inline-block">
          ...
          <h1 className="tracking-tight inline font-semibold from-red-400 to-red-600 text-[2.5rem] lg:text-5xl bg-clip-text text-transparent bg-gradient-to-b">
            HospiLock&nbsp;
          </h1>
          <h1 className='tracking-tight inline font-semibold text-[2.5rem] lg:text-4xl'>
            admin app
